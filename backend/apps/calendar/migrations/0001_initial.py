    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type', models.CharField(choices=[('course', 'Course Event'), ('user', 'User Event'), ('site', 'Site Event')], default='user', max_length=10)),
                ('start_date', models.DateTimeField()),
                ('end_date', models.DateTimeField(blank=True, null=True)),
                ('repeat', models.JSONField(blank=True, null=True)),
